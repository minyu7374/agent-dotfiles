...
Coherence takes priority over a small diff: decide the coherent shape here first, *then* make it as small as possible per the `minimal-change` rule. The two are ordered, not in tension.

For the full playbook — the patch-style trap, the signals of harmony vs. bolt-on, scope discipline, and the finish checklist — use the **architectural-coherence** skill.

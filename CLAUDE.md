...
| `rules/diagrams-svg-first.md` | always-on rule (Claude); diagrams in technical docs go in SVG (or mermaid where rendered), not ASCII art. Mirrored to `memories/agent-principles.md` for Codex/Gemini |
